...
export default function SearchBar({ onSearch, isLoading }: SearchBarProps) {
  ...
  const onSubmit = (data: SearchFormValues) => {
    ...
    if (data.query === lastSubmitted.query && data.location === lastSubmitted.location) {
      return;
    }
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 md:space-y-0 md:flex md:gap-4">
